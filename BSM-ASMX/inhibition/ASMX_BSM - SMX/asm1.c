...
k_bio_ox = mxGetPr(PAR)[29];
K_D_ax = mxGetPr(PAR)[30];
k_Dec_ax = mxGetPr(PAR)[31];
k_bio_ax = mxGetPr(PAR)[32];
n_Dec = mxGetPr(PAR)[33];
n_bio = mxGetPr(PAR)[34];
...
proc11 = k_Dec_ox*xtemp[17]*((K_S*n_Dec)/((K_S*n_Dec)+xtemp[1]))*(xtemp[7]/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
proc12 = k_bio_ox*xtemp[16]*((K_S*n_bio)/((K_S*n_bio+xtemp[1])))*(xtemp[7]/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
...
proc14 = k_Dec_ax*xtemp[17]*((K_S*n_Dec)/((K_S*n_Dec)+xtemp[1]))*(K_OH/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
proc15 = k_bio_ax*xtemp[16]*((K_S*n_bio)/((K_S*n_bio)+xtemp[1]))*(K_OH/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
