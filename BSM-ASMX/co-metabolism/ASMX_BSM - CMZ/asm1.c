 ...
 * and Laura J.P. Snip
 * CAPEC-PROCESS, Technical University of Denmark, Lyngby, Denmark
...
double k_Des, K_D_ox, k_Dec_ox, q_c_ox, k_bio_ox, K_D_ax, k_Dec_ax, q_c_ax, k_bio_ax, X_SS;
double proc1, proc2, proc3, proc4, proc5, proc6, proc7, proc8, proc3x;
double proc9, proc10, proc11, proc12, proc13, proc14, proc15;
...
/* Parameters for ASM-X Carbamazepine*/
k_Des = mxGetPr(PAR)[26];
K_D_ox = mxGetPr(PAR)[27]; 
k_Dec_ox = mxGetPr(PAR)[28];
q_c_ox = mxGetPr(PAR)[29];
k_bio_ox = mxGetPr(PAR)[30];

K_D_ax = mxGetPr(PAR)[31];
k_Dec_ax = mxGetPr(PAR)[32];
q_c_ax = mxGetPr(PAR)[33];
k_bio_ax = mxGetPr(PAR)[34];
...
proc9  = k_Des*xtemp[19];

proc10 = k_Des*K_D_ox*xtemp[16]*(xtemp[7]/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
proc11 = k_Dec_ox*xtemp[17]*(xtemp[7]/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
proc12 = ((q_c_ox*(xtemp[1]/(K_S+xtemp[1])))+k_bio_ox)*xtemp[16]*(xtemp[7]/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);

proc13 = k_Des*K_D_ax*xtemp[16]*(K_OH/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
proc14 = k_Dec_ax*xtemp[17]*(K_OH/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
proc15 = ((q_c_ax*(xtemp[1]/(K_S+xtemp[1])))+k_bio_ax)*xtemp[16]*(K_OH/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
}
...
/* CLI */ reac16 = proc9 - proc10 + proc11 - proc12 - proc13 + proc14 - proc15;
/* CCJ */ reac17 = -proc11 - proc14;
reac18 = 0.0; 
/* CSL */ reac19 = -proc9 + proc10 + proc13;
reac20 = 0.0;
