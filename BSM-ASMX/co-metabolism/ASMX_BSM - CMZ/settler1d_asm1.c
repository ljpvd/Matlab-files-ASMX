...
double k_Des, K_D_ox, k_Dec_ox, q_c_ox, k_bio_ox, K_D_ax, k_Dec_ax, q_c_ax, k_bio_ax, X_SS, n_Dec, n_bio;

double proc1[10], proc2[10], proc3[10], proc4[10], proc5[10], proc6[10], proc7[10], proc8[10];
double proc9[10], proc10[10], proc11[10], proc12[10], proc13[10], proc14[10], proc15[10];
...
k_Des = mxGetPr(ASMPAR)[26];
K_D_ox = mxGetPr(ASMPAR)[27]; 
k_Dec_ox = mxGetPr(ASMPAR)[28];
q_c_ox = mxGetPr(ASMPAR)[29];
k_bio_ox = mxGetPr(ASMPAR)[30];
K_D_ax = mxGetPr(ASMPAR)[31];
k_Dec_ax = mxGetPr(ASMPAR)[32];
q_c_ax = mxGetPr(ASMPAR)[33];
k_bio_ax = mxGetPr(ASMPAR)[34];
n_Dec = mxGetPr(ASMPAR)[35];
n_bio = mxGetPr(ASMPAR)[36];
...
proc9[i] =  k_Des*xtemp[i+180];
proc10[i] = k_Des* K_D_ox *xtemp[i+160]*(xtemp[i+70]/(K_OH+xtemp[i+70]))*(X_I2TSS*xtemp[i+20]+X_S2TSS*xtemp[i+30]+X_BH2TSS*xtemp[i+40]+X_BA2TSS*xtemp[i+50]+X_P2TSS*xtemp[i+60]);
//proc11[i] = kDec_ox * xtemp[i+170]*(K_S*ny_Dec /((K_S*ny_Dec)+xtemp[i+10]))*(xtemp[i+70]/(K_OH+xtemp[i+70]))*(X_I2TSS*xtemp[i+20]+X_S2TSS*xtemp[i+30]+X_BH2TSS*xtemp[i+40]+X_BA2TSS*xtemp[i+50]+X_P2TSS*xtemp[i+60]);
//proc12[i] = kBio_ox * xtemp[i+160]*(K_S*ny_Bio /((K_S*ny_Bio)+xtemp[i+10]))*(xtemp[i+70]/(K_OH+xtemp[i+70]))*(X_I2TSS*xtemp[i+20]+X_S2TSS*xtemp[i+30]+X_BH2TSS*xtemp[i+40]+X_BA2TSS*xtemp[i+50]+X_P2TSS*xtemp[i+60]);
proc13[i] = k_Des* K_D_ax *  xtemp[i+160] * (K_OH/(K_OH+xtemp[i+70]))*(X_I2TSS*xtemp[i+20]+X_S2TSS*xtemp[i+30]+X_BH2TSS*xtemp[i+40]+X_BA2TSS*xtemp[i+50]+X_P2TSS*xtemp[i+60]);
//proc14[i] = kDec_anox* xtemp[i+170]*(K_S*ny_Dec /((K_S*ny_Dec)+xtemp[i+10]))* (K_OH/(K_OH+xtemp[i+70]))*(X_I2TSS*xtemp[i+20]+X_S2TSS*xtemp[i+30]+X_BH2TSS*xtemp[i+40]+X_BA2TSS*xtemp[i+50]+X_P2TSS*xtemp[i+60]);
//proc15[i] = kBio_anox* xtemp[i+160]*(K_S*ny_Bio /((K_S*ny_Bio)+xtemp[i+10]))* (K_OH/(K_OH+xtemp[i+70]))*(X_I2TSS*xtemp[i+20]+X_S2TSS*xtemp[i+30]+X_BH2TSS*xtemp[i+40]+X_BA2TSS*xtemp[i+50]+X_P2TSS*xtemp[i+60]);
...
reac17[i] = 0.0;
reac18[i] = 0.0;
reac19[i] = -proc9[i] + proc10[i] + proc13[i];
reac20[i] = 0.0;
