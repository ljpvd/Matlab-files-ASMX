...
% Xavier Flores-Alsina, IEA, LTH, Sweden
...
load inDCF %% generated using Markov Chains
...
Cli_gperPEperd=58e-3;                       % Cli load in g /d per 1000 PE (g DCF day-1 PE-1)CLi load measured average daily influent (original values = 58 mg day-1 1000 PE)
Ccj_gperPEperd=65e-3;                       % Ccj load in g /d per 1000 PE (g dcf day-1 PE-1)Ccj load measured average daily influent (original values = 65 mg day-1 1000 PE)
...
% ASM1 X state values
ASM1_XINIT=[0.25 0.1 0.1 0.1 0.0 0.0 0.02 0.1 0.1];% Initital conditions (7 states) XINIT= [TSS  XI  XS  XBH  XBA  XP  XND]
...
k_Des_DCF =     100e-3;    % Desortion rate coefficient for Csl
q_c_ox =        1.6e-3;  % aerobic maximum specific cometabolic substrate biotransformation rate
q_c_anox =      0.96e-3;  % anoxic maximum specific cometabolic substrate biotransformation rate
KD_ox_DCF =     0.019e-3;   % aerobic solid-liquid sortion coefficient
kDec_ox_DCF =   5.0e-3;   % aerobic biotransformation rate coefficient for Csj
kBio_ox_DCF =   0.14e-3;   % aerobic biotransformation rate coefficient for Cli
KD_anox_DCF =   0.019e-3;   % anoxic solid-liquid sortion coefficient     
kDec_anox_DCF = 5.0e-3;   % anoxic biotransformation rate coefficient for Csj
kBio_anox_DCF = 0.1e-3;   % anoxic biotransformation rate coefficient for Cli

ASMX = [k_Des_DCF q_c_ox q_c_anox  KD_ox_DCF  kDec_ox_DCF kBio_ox_DCF  KD_anox_DCF kDec_anox_DCF kBio_anox_DCF ];
