...
BSM1LT_Influent=[(0:1/96:609)',simout_afterprimary];
...
IQvec=(BSS*SSin+BCOD*CODin+BNKj*SNKjin+BNO*SNOin+BBOD5*BOD5in).*ASM1_Influentpart(:,16);
IQvec_new=(BSS*SSin+BCOD*CODin+BNKj_new*SNKjin+BNO_new*SNOin+BBOD5*BOD5in).*ASM1_Influentpart(:,16); %updated BSM TG meeting no 8
...
disp(' ')
disp(['Influent average C_li load = ',num2str(Cli_inload/(PE*totalt)),' g /day 1000 PE-1'])
disp(['Influent average C_cj load = ',num2str(Ccj_inload/(PE*totalt)),' g /day 1000 PE-1'])
disp(['Influent average C_sl load = ',num2str(Csl_inload/(PE*totalt)),' g /day 1000 PE-1'])
disp(['Influent average Csl_i load = ',num2str(Csl_i_inload/(PE*totalt)),' g /day 1000 PE-1'])
...
Csl_invec_m = std((ASM1_Influentpart(:,21).*ASM1_Influentpart(:,16))./(1000.*PE));
Csl_i_invec_m = std((ASM1_Influentpart(:,22).*ASM1_Influentpart(:,16))./(1000.*PE));

%///////////////////////////
disp(['Influent average desv C_li load = ',num2str(Cli_invec_m),' g /day'])
disp(['Influent average desv C_cj load = ',num2str(Ccj_invec_m),' g /day'])
disp(['Influent average desv C_sl load = ',num2str(Csl_invec_m),' g /day'])
disp(['Influent average desv Csl_i load = ',num2str(Csl_i_invec_m ),' g /day'])
...
Qdynamic =      BSM1LT_Influentpart(:,16);
