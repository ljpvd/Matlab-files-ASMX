 ...
 *            Laura J.P. Snip, Krist V. Gernaey, DTU. Denmark
 */
...
k_Des = mxGetPr(ASMX)[0];
q_c_ox = mxGetPr(ASMX)[1];
q_c_anox = mxGetPr(ASMX)[2];
KD_ox = mxGetPr(ASMX)[3];
kDec_ox = mxGetPr(ASMX)[4];
kBio_ox = mxGetPr(ASMX)[5];
KD_anox = mxGetPr(ASMX)[6];
kDec_anox = mxGetPr(ASMX)[7];
kBio_anox = mxGetPr(ASMX)[8];
...
proc11 = kDec_ox * xtemp[14]*(xtemp[7]/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
proc12 = (q_c_ox *(xtemp[1]/(K_S+xtemp[1])) + kBio_ox)* xtemp[13]*(xtemp[7]/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
...
proc14 = kDec_anox* xtemp[14]* (K_OH/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
proc15 = (q_c_anox *(xtemp[1]/(K_S+xtemp[1]))+ kBio_anox) * xtemp[13]* (K_OH/(K_OH+xtemp[7]))*(X_I2TSS*xtemp[2]+X_S2TSS*xtemp[3]+X_BH2TSS*xtemp[4]+X_BA2TSS*xtemp[5]+X_P2TSS*xtemp[6]);
