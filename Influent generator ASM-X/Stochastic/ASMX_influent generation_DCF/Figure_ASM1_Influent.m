...
% Laura J.P. Snip, CAPEC-PROCESS, Technical University of Denmark, Lyngby,
% Denmark
...
corSNH_Cli = corr(ASM1_Influentpart(:,11),ASM1_Influentpart(:,18));
...
Cli_invec1(position1 + 0 :position1 + 31,1) = ASM1_Influentpart(position + 0  :position + 31,18); 
...
Cli_invec2(position1 + 0 :position1 + 31,1) = ASM1_Influentpart(position + 32  :position + 63,18); 
...
Cli_invec3(position1 + 0 :position1 + 31,1) = ASM1_Influentpart(position + 64  :position + 95,18); 
...
% 
 % figure(8)
% plot (time_eval(1:(end-1)),Ccjdynamic,'b')
% hold on
% plot (time_eval(1:(end-1)),Ccjdynamic_smooth,'r')
% xlabel ('time (days)')
% xlim([245 609])
% title('Influent dynamic Ccj CIP');
% hold off
% 
% figure(9)
% plot (time_eval(1:(end-1)),Csldynamic,'b')
% hold on
% plot (time_eval(1:(end-1)),Csldynamic_smooth,'r')
% xlabel ('time (days)')
% xlim([245 609])
% title('Influent dynamic Csl CIP');
% hold off
